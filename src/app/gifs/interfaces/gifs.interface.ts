// To parse this data:
//
//   import { Convert, SearchGiftResponse } from "./file";
//
//   const searchGiftResponse = Convert.toSearchGiftResponse(json);
//
...
export class Convert {
  public static toSearchGiftResponse(json: string): SearchGiftResponse {
    return cast(JSON.parse(json), r('SearchGiftResponse'));
  }

  public static searchGiftResponseToJson(value: SearchGiftResponse): string {
    return JSON.stringify(uncast(value, r('SearchGiftResponse')), null, 2);
  }
}
